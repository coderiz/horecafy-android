...
//                mAvailabilityList = data.filter { it.id != -1 }
    ...
    private fun setAdapter() {
        ...
        val category = Category(0, Constants.CONSTANT_CREATE_LIST_FIRST_ELEMENT, "", "First", false, 0, 0)
        categories.add(0, category)

        // Set the adapter
        val adapter = CategoryRecyclerViewAdapter(this@CustomerCreateListCategoryActivity, categories)
